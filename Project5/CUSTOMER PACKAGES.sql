...
AS
    ...
    PROCEDURE MEMBERSHIP_REGISTER_CHOICE(EMAIL IN CUSTOMER.EMAIL_ID%TYPE,MEM_ID IN MEMBERSHIP.MEMBERSHIP_ID%TYPE);
    ...
    PROCEDURE WALLET_REGISTRATION(W_ID OUT WALLET.WALLET_ID%TYPE);
...
BEGIN
    ...
    END IF;
    EXECUTE IMMEDIATE 'SELECT * FROM AVAILABLE_BIKE';
    FOR RECORD IN (SELECT * FROM AVAILABLE_BIKE)
    LOOP
...
END END_RIDE;
    ...
    PROCEDURE MEMBERSHIP_REGISTER_CHOICE(EMAIL IN CUSTOMER.EMAIL_ID%TYPE,MEM_ID IN MEMBERSHIP.MEMBERSHIP_ID%TYPE) AS
    BAL WALLET.BALANCE%TYPE;
    VAL NUMBER;
...
END MEMBERSHIP_REGISTER_CHOICE;
...
END UPDATE_CUSTOMER_DETAILS;
    ...
    PROCEDURE WALLET_REGISTRATION(W_ID OUT WALLET.WALLET_ID%TYPE) AS
    VAL NUMBER;
BEGIN
