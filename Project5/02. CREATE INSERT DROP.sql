...
INSERT INTO TICKETING_QUEUE (TICKET_ID, CUSTOMER_ID, TICKET_AGENT, TICKET_URGENCY, TICKET_DESC, INITIALISED_AT, ASSIGNED_AT, CLOSED_AT) VALUES (TICKET_ID_SEQUENCE.NEXTVAL, CUSTOMER_ID_SEQUENCE.CURRVAL,10000000,'MEDIUM','MEMBERSHIP RENEWAL ISSUES', '01-JAN-2003 23:05:07 ', '01-JAN-2003 23:06:20 ', '01-JAN-2003 23:20:33 ');
...
INSERT INTO TICKETING_QUEUE (TICKET_ID, CUSTOMER_ID, TICKET_AGENT, TICKET_URGENCY, TICKET_DESC, INITIALISED_AT, ASSIGNED_AT, CLOSED_AT) VALUES (TICKET_ID_SEQUENCE.NEXTVAL, CUSTOMER_ID_SEQUENCE.CURRVAL,10000005,'HIGH','RENT OVERCHARGING ISSUE', '01-JAN-2003 14:05:07 ', '01-JAN-2003 14:06:20 ', '01-JAN-2003 14:20:33 ');
...
INSERT INTO TICKETING_QUEUE (TICKET_ID, CUSTOMER_ID, TICKET_AGENT, TICKET_URGENCY, TICKET_DESC, INITIALISED_AT, ASSIGNED_AT, CLOSED_AT) VALUES (TICKET_ID_SEQUENCE.NEXTVAL, CUSTOMER_ID_SEQUENCE.CURRVAL,10000012,'MEDIUM','RIDE EXTENSION ISSUE', '01-JAN-2003 18:05:07 ', '01-JAN-2003 18:06:20 ', '01-JAN-2003 18:20:33 ');
...
INSERT INTO TICKETING_QUEUE (TICKET_ID, CUSTOMER_ID, TICKET_AGENT, TICKET_URGENCY, TICKET_DESC, INITIALISED_AT, ASSIGNED_AT, CLOSED_AT) VALUES (TICKET_ID_SEQUENCE.NEXTVAL, CUSTOMER_ID_SEQUENCE.CURRVAL,10000008,'MEDIUM','COUPON ISSUE', '01-JAN-2003  16:05:07 ', '01-JAN-2003  16:06:20 ', '01-JAN-2003  16:20:33 ');
...
--INSERTS IN RENT
INSERT INTO RENT (PAYMENT_ID,CUSTOMER_ID,BIKE_ID,PICKUP_TIME,DROP_TIME,COUPON_ID)
VALUES(PAYMENT_ID_SEQUENCE.NEXTVAL,10000,1001,SYSDATE,SYSDATE + INTERVAL '60' MINUTE,11);

INSERT INTO RENT (PAYMENT_ID,CUSTOMER_ID,BIKE_ID,PICKUP_TIME,DROP_TIME,COUPON_ID)
VALUES(PAYMENT_ID_SEQUENCE.NEXTVAL,10001,1002,SYSDATE,SYSDATE + INTERVAL '60' MINUTE,NULL);

INSERT INTO RENT (PAYMENT_ID,CUSTOMER_ID,BIKE_ID,PICKUP_TIME,DROP_TIME,COUPON_ID)
VALUES(PAYMENT_ID_SEQUENCE.NEXTVAL,10002,1003,SYSDATE,SYSDATE + INTERVAL '60' MINUTE,12);

INSERT INTO RENT (PAYMENT_ID,CUSTOMER_ID,BIKE_ID,PICKUP_TIME,DROP_TIME,COUPON_ID)
VALUES(PAYMENT_ID_SEQUENCE.NEXTVAL,10003,1004,SYSDATE,SYSDATE + INTERVAL '60' MINUTE,13);

INSERT INTO RENT (PAYMENT_ID,CUSTOMER_ID,BIKE_ID,PICKUP_TIME,DROP_TIME,COUPON_ID)
VALUES(PAYMENT_ID_SEQUENCE.NEXTVAL,10004,1005,SYSDATE,SYSDATE + INTERVAL '60' MINUTE,11);
